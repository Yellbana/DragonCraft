...
public class BlockDragonPortal extends BlockPortal {
    public BlockDragonPortal(int id) {
        super(id);
    ...
    public void onNeighborBlockChange(World par1World, int par2, int par3, int par4, int par5) {
        ...
        if (par1World.getBlockId(par2, var8 - 1, par4) != Block.blockGold.blockID) {
            ...
            if (var9 == 3 && par1World.getBlockId(par2, var8 + var9, par4) == Block.blockGold.blockID) {
                ...
                if (var10 && var11) {
                    ...
                    if ((par1World.getBlockId(par2 + var6, par3, par4 + var7) != Block.blockGold.blockID || par1World.getBlockId(par2 - var6, par3, par4 - var7) != this.blockID) && (par1World.getBlockId(par2 - var6, par3, par4 - var7) != Block.blockGold.blockID || par1World.getBlockId(par2 + var6, par3, par4 + var7) != this.blockID)) {
                        par1World.setBlock(par2, par3, par4, 0);
                    }
                }
            } else {
