...
public class ItemDragonSphere extends Item {
    public ItemDragonSphere(int par1) {
        super(par1);
    ...
    public boolean onItemUse(ItemStack par1ItemStack, EntityPlayer par2EntityPlayer, World par3World, int X, int Y, int Z, int par7, float par8, float par9, float par10) {
        if (!par3World.isRemote) {
            ...
            if ((direction == 1) || (direction == 3)) {
                ...
                par3World.setBlock(X, Y + 1, Z, Block.blockGold.blockID);
                par3World.setBlock(X + 1, Y + 1, Z, Block.blockGold.blockID);
                par3World.setBlock(X, Y + 2, Z, Block.blockGold.blockID);
                par3World.setBlock(X + 1, Y + 2, Z, Block.blockGold.blockID);
                par3World.setBlock(X + 2, Y + 2, Z, Block.blockGold.blockID);
                par3World.setBlock(X - 1, Y + 2, Z, Block.blockGold.blockID);
                par3World.setBlock(X + 3, Y + 3, Z, Block.blockGold.blockID);
                par3World.setBlock(X - 2, Y + 3, Z, Block.blockGold.blockID);
                par3World.setBlock(X + 2, Y + 3, Z, Block.blockGold.blockID);
                par3World.setBlock(X - 1, Y + 3, Z, Block.blockGold.blockID);
                par3World.setBlock(X + 3, Y + 4, Z, Block.blockGold.blockID);
                par3World.setBlock(X - 2, Y + 4, Z, Block.blockGold.blockID);
                par3World.setBlock(X + 2, Y + 4, Z, Block.blockGold.blockID);
                par3World.setBlock(X - 1, Y + 4, Z, Block.blockGold.blockID);
                par3World.setBlock(X + 3, Y + 5, Z, Block.blockGold.blockID);
                par3World.setBlock(X - 2, Y + 5, Z, Block.blockGold.blockID);
                par3World.setBlock(X + 2, Y + 5, Z, Block.blockGold.blockID);
                par3World.setBlock(X - 1, Y + 5, Z, Block.blockGold.blockID);
                par3World.setBlock(X + 2, Y + 6, Z, Block.blockGold.blockID);
                par3World.setBlock(X - 1, Y + 6, Z, Block.blockGold.blockID);
                par3World.setBlock(X, Y + 7, Z, Block.blockGold.blockID);
                par3World.setBlock(X + 1, Y + 7, Z, Block.blockGold.blockID);
                par3World.setBlock(X, Y + 6, Z, Block.blockGold.blockID);
                par3World.setBlock(X + 1, Y + 6, Z, Block.blockGold.blockID);
                par3World.setBlock(X, Y + 3, Z, Blocks.dragonFire.get().blockID);
            } else {
                for (int y = 1; y < 5; y++) {
                    for (int x = -1; x < 2; x++) {
